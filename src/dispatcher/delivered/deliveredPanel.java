 ...
 */
package dispatcher.delivered;

import configuration.config;
import dispatcher.connector;
import dispatcher.pendingParcelPanel;
 ...
 * @author user
 */
public class deliveredPanel extends javax.swing.JInternalFrame {

    /**
     * Creates new form deliveredPanel
     */
    ...
    public deliveredPanel(JDesktopPane pane) {
        this.MainPane = pane;
    ...
    public void DisplayParcels(){
        ...
        String qry = "SELECT export_id, reference_number, export_status, export_reciever FROM exports WHERE export_status = 'Delivered'";
