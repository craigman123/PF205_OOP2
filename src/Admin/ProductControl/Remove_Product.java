 ...
 * @author user
 */
public class Remove_Product extends javax.swing.JInternalFrame {
    ...
    public void EraseProduct() {
        ...
        String mainid = mainID.getText().trim();
        ...
        if (!result.isEmpty()) {
            ...
            qry = "DELETE FROM products WHERE prod_id = ?";
            conf.deleteRecord(qry, finalID);

            JOptionPane.showMessageDialog(
                    null,
                    "Product ID " + finalID + " deleted successfully.",
                    "Success",
    ...
    public void EraseMultipleProduct() {
        config conf = new config();
        int finalID;
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            if (!text.isEmpty() && !text.equals("ID " + (i + 1))) {
                ...
                try {
                    ...
                    error.append("TextField ")
                         .append(i + 1)
                         .append(": Input must be an integer.\n");
                }
            }
        }
        ...
        if (successCount > 0) {
            JOptionPane.showMessageDialog(
                    null,
                    successCount + " product(s) successfully deleted.",
                    "Success",
                    JOptionPane.INFORMATION_MESSAGE
            );
        }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(id7, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(id5, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 259, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap())
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(id3)
                            .addComponent(id1, javax.swing.GroupLayout.PREFERRED_SIZE, 259, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(id6)
                            .addComponent(id4)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(mainID, javax.swing.GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE))
                .addGap(35, 35, 35)
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        EraseProduct();        // TODO add your handling code here:
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        EraseMultipleProduct();        // TODO add your handling code here:
